...
<div class="resource">
                    <h3 class="resource-heading">find_book_details</h3>
                    <p>find_book_details</p>
                    <div class="action get">
                        <h4 class="action-heading">
                            <div class="name">find_book_details</div>
                            <a href="#" class="method post">POST</a>
                            <code class="uri">/api/books</code>
                        </h4>
                        <h4>Example URL</h4>
                        <div class="definition">
                            <span class="method post">POST</span>&nbsp;<span class="uri">
                            <span class="hostname">http://localhost:3000</span>
                            /api/books</span>
                        </div>
                        <div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong>
                            <div class="inner">
                            <pre><code class="language-json">{"status": 1, "book_name": "Sample Book One", "price": 123}</code></pre>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="resource">
                    <h3 class="resource-heading">find_author_details</h3>
                    <p>find_author_details</p>
                    <div class="action get">
                        <h4 class="action-heading">
                            <div class="name">find_author_details</div>
                            <a href="#" class="method post">POST</a>
                            <code class="uri">/api/authors</code>
                        </h4>
                        <h4>Example URL</h4>
                        <div class="definition">
                            <span class="method post">POST</span>&nbsp;<span class="uri">
                        ...
                        <div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong>
                            <div class="inner">
                            <pre><code class="language-json">{"status": 1, "author_name": "Mr. Author", "books": 31}</code></pre>
                            </div>
                        </div>
                    </div>
                </div>
