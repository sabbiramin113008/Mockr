...
<div class="resource">
                    <h3 class="resource-heading">Find Book Details</h3>
                    <p></p>
                    <div class="action get">
                        <h4 class="action-heading">
                            <div class="name">Find Book Details</div>
...
<div class="resource">
                    <h3 class="resource-heading">Find Author Details</h3>
                    <p></p>
                    <div class="action get">
                        <h4 class="action-heading">
                            <div class="name">Find Author Details</div>
                            <a href="#" class="method post">POST</a>
